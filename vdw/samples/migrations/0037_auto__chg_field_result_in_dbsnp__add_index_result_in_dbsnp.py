...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Result.in_dbsnp'
        db.alter_column('sample_result', 'in_dbsnp', self.gf('django.db.models.fields.BooleanField')())
        # Adding index on 'Result', fields ['in_dbsnp']
        db.create_index('sample_result', ['in_dbsnp'])


    def backwards(self, orm):
        # Removing index on 'Result', fields ['in_dbsnp']
        db.delete_index('sample_result', ['in_dbsnp'])


        # Changing field 'Result.in_dbsnp'
        db.alter_column('sample_result', 'in_dbsnp', self.gf('django.db.models.fields.NullBooleanField')(null=True))
    ...
    models = {
        ...
        'samples.result': {
            ...
            'id': ('vdw.core.models.BigAutoField', [], {'primary_key': 'True'}),
            'in_dbsnp': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
