...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        orm['samples.Result'].objects.filter(in_dbsnp__isnull=True)\
                                     .update(in_dbsnp=False)

    def backwards(self, orm):
        # There is no safe way back because we are not sure what was null and
        # what was already False when we moved forward. There should be no
        # issue with leaving all the False values as False though and not
        # having any nulls.
        pass
