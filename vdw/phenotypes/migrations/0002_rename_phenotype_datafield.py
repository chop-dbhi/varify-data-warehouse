...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        orm['avocado.DataField'].objects.filter(app_name='phenotype').update(app_name='phenotypes')


    def backwards(self, orm):
        "Write your backwards methods here."
        orm['avocado.DataField'].objects.filter(app_name='phenotypes').update(app_name='phenotype')
